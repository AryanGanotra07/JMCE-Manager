...
class SubjectListAdapter(val deleteCourseCallback : DeleteCourseCallback, val onCourseClick: OnCourseClick) : RecyclerView.Adapter<SubjectListAdapter.ViewHolder>() {
